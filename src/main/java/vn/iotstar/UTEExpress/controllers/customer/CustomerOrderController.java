...
public class CustomerOrderController {
    ...
    public String createOrder(@PathVariable("id") Integer id,
    	    ...
    	    @RequestParam("codFee") float codFee,
    	    @RequestParam("shipFee") float shipFee,
    	    @RequestParam("goodsID") Integer goodsID,
    	    @RequestParam("transportID") Integer transportID,
    	    @RequestParam("voucherID") Integer voucherID,
    	    @RequestParam("COD_surcharge") float codSurcharge,
        ...
        Transport transport = transportService.findById(transportID);  // Giả sử bạn đã lấy được transport từ cơ sở dữ liệu
